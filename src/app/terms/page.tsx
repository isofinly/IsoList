    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-text-secondary">
            By using IsoSpace, you agree to these terms. If you don&apos;t agree with any part of these terms,
            please don&apos;t use our service.
          </p>
          <p className="text-text-secondary">
            We may update these terms from time to time. When we do, we&apos;ll update the &quot;Last updated&quot; date
            at the top of this page. Continued use of IsoSpace after changes means you accept the new
            terms.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-text-secondary">
            IsoSpace is provided free of charge for personal, non-commercial use. We don&apos;t charge fees,
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary mb-2">
                You agree to use IsoSpace only for lawful purposes. You will not:
              </p>
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary">
                While IsoSpace automatically backs up your data to Google Drive, you&apos;re responsible for
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-text-secondary">
            We strive to keep IsoSpace available 24/7, but we can&apos;t guarantee uninterrupted service. The
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-error-soft/20 border border-error-soft rounded-lg p-4">
            ...
            <p className="text-sm text-text-secondary">
              IsoSpace is provided &quot;as is&quot; without warranties of any kind. While we work hard to provide a
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-text-secondary">
              ...
              use of IsoSpace. This includes but is not limited to data loss, business interruption, or
              lost profits.
            </p>

            <p className="text-sm text-text-secondary">
              Our total liability to you for any claims related to IsoSpace will not exceed the amount you
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-1 gap-4">
            <div>
              ...
              <p className="text-sm text-text-secondary">
                You can stop using IsoSpace at any time. To completely remove your data, revoke access to
                your Google account and delete any IsoSpace files from your Google Drive.
              </p>
            </div>
          </div>
        </CardContent>

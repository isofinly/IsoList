  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>IsoSpace is free to use for personal purposes</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-success">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-success">✓</span>
                <span>
                  We don&apos;t sell your data or show ads or track you in any
                  way
                </span>
              </li>
            </ul>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>Don&apos;t use IsoSpace for anything illegal</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-warning">!</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-warning">!</span>
                <span>
                  You&apos;re responsible for your Google account security
                </span>
              </li>
            </ul>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-text-secondary">
            By using IsoSpace, you agree to these terms. If you don&apos;t agree
            with any part of these terms, please don&apos;t use our service.
          </p>
          <p className="text-text-secondary">
            We may update these terms from time to time. When we do, we&apos;ll
            update the &quot;Last updated&quot; date at the top of this page.
            Continued use of IsoSpace after changes means you accept the new
            terms.
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-success-soft/20 border border-success-soft rounded-lg p-4">
            ...
            <ul className="text-sm text-text-secondary space-y-1">
              <li>
                • A web application for tracking movies, TV series, and anime
              </li>
          ...
          <p className="text-text-secondary">
            IsoSpace is provided free of charge for personal, non-commercial
            use. We don&apos;t charge fees, show advertisements, or monetize
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-text-secondary">
                ...
                Google account. This includes using strong passwords, enabling
                two-factor authentication, and keeping your account information
                current.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary mb-2">
                You agree to use IsoSpace only for lawful purposes. You will
                not:
              </p>
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary">
                While IsoSpace automatically backs up your data to Google Drive,
                you&apos;re responsible for maintaining additional backups if
                desired. We recommend periodically exporting your data as an
                extra precaution.
              </p>
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-info-soft/20 border border-info-soft rounded-lg p-4">
            ...
            <ul className="text-sm text-text-secondary space-y-1">
              <li>
                • Your data is stored in your personal Google Drive, not on our
                servers
              </li>
              <li>
                • We cannot access your personal media tracking information
              </li>
              <li>• You can export or delete your data at any time</li>
              <li>
                • We use minimal Google account information for authentication
                only
              </li>
            </ul>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-text-secondary">
            We strive to keep IsoSpace available 24/7, but we can&apos;t
          ...
          <p className="text-text-secondary">
            Since your data is stored locally and in your Google Drive, you can
            continue using the core tracking features even when our servers are
            unavailable.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-error-soft/20 border border-error-soft rounded-lg p-4">
            ...
            <p className="text-sm text-text-secondary">
              IsoSpace is provided &quot;as is&quot; without warranties of any
              kind. While we work hard to provide a reliable service, we cannot
              guarantee it will meet all your needs or be completely error-free.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-text-secondary">
              ...
              damages arising from your use of IsoSpace. This includes but is
              not limited to data loss, business interruption, or lost profits.
            </p>

            <p className="text-sm text-text-secondary">
              Our total liability to you for any claims related to IsoSpace will
              not exceed the amount you paid us for the service (which is
              currently $0, as the service is free).
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-1 gap-4">
            <div>
              ...
              <p className="text-sm text-text-secondary">
                You can stop using IsoSpace at any time. To completely remove
                your data, revoke access to your Google account and delete any
                IsoSpace files from your Google Drive.
              </p>
            </div>
          </div>
        </CardContent>
